...
public class BiFunctionAndThenExample2 {
	...
	public static void main(String[] args) {
		BiFunction<String, Integer, Integer> bifunction = (designation, age) -> getSalaryByAgeAndDesig(designation, age);
	...
	private static Integer getSalaryByAgeAndDesig(String designation, Integer age) {
